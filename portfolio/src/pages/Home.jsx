      ...
      <div className="w-full flex flex-col items-center justify-center flex-grow overflow-hidden">
        <div className="flex flex-col space-y-5 items-center justify-center  flex-grow">
          <div className="w-full text-center">
            <h1 className="text-4xl md:text-5xl anton-sc-regular tracking-widest dark:text-[#CC8BF2] font-semibold z-10">
              MUHAMMAD ABDULLAH WAQAR
            </h1>
          </div>
          <div className="flex flex-col justify-center items-center w-full">
            <img src={main} alt="" className= {`${darkMode? "": "hidden"} h-80 w-80 z-0`} />
            <img src={dark} alt="" className=" dark:hidden h-80 w-80 z-0" />
