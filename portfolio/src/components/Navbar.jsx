...
function Navbar() {
  ...
  return (
    <div className="w-screen flex dark:text-white md:my-2 text-black items-center justify-between md:justify-center md:px-4 py-4">
      ...
      <div className="md:hidden flex items-center mr-2">
        ...
        <div
          className={`flex flex-col bg-white z-50 dark:bg-purple-900 bg-opacity-20 dark:bg-opacity-100 absolute ${
